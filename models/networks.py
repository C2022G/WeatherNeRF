...
class NGP(nn.Module):
    def __init__(self, scale, rgb_act='Sigmoid'):
        ...
        self.register_buffer("density_grid", torch.ones(self.cascades, self.grid_size ** 3) * 250)
        self.register_buffer("grid_coords", create_meshgrid3d(self.grid_size, self.grid_size, self.grid_size, False,
